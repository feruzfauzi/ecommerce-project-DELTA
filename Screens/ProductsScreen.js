            ...
            { modalVisible &&
               ...
               <form onSubmit={submitHandler}>
                   <ul className="form-container">
                       ...
                       <li>
                           <button type="submit" className="button full-width">{id?"Update":"Create"}</button>
                       </li>
                       <li>
                           <button type="submit" onClick={()=>setModalVisible(false)} className="button-secondary full-width">Back</button>
                       </li>
                ...
                <table className="table">
                    ...
                    <tbody>
                        {products.map(product=> (<tr key={product._id}>
                            ...
                            <td>{product.brand}</td>
                            <td>
                                <button className="button-style" onClick={()=>openModal(product)}>Edit</button>
                                {' '}
                                <button className="button-style" onClick={()=>deleteHandler(product)}>Delete</button>
                            </td>
                        </tr>))}
